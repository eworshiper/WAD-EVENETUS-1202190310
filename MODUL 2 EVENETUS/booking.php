                        ...
                        <form action="mybooking.php" method="POST">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="Catering" id="catering" name="service">
                                    <label class="form-check-label" for="catering">Catering / $700</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="Decoration" id="decoretion" name="service">
